...
![Three interpenetrating triangles, per-pixel depth resolved](images/day2-color.png)


![Depth buffer visualised as greyscale, near is bright](images/day2-depth.png)
